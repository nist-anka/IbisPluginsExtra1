...
#include "movecutplanesplugininterface.h"
#include <QtPlugin>
#include <QFileDialog>
#include <QString>
...
MoveCutPlanesPluginInterface::MoveCutPlanesPluginInterface()
{
}
...
QWidget * MoveCutPlanesPluginInterface::CreateFloatingWidget()
{
